...
import com.kunal.ecart.options.SearchResultActivity;
import com.kunal.ecart.options.WishlistActivity;
...
public class Display2 extends AppCompatActivity
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        NotificationCountSetClass.setAddToCart(Display2.this, item,notificationCountCart);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            startActivity(new Intent(Display2.this, SearchResultActivity.class));
            return true;
        }else if (id == R.id.action_cart) {

           /* NotificationCountSetClass.setAddToCart(MainActivity.this, item, notificationCount);
            invalidateOptionsMenu();*/
            startActivity(new Intent(Display2.this, CartListActivity.class));
           ...
           /* notificationCount=0;//clear notification count
            ...
            startActivity(new Intent(Display2.this, Display.class));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_item1) {
            ...
            startActivity(new Intent(Display2.this, WishlistActivity.class));
        ...
        else if (id == R.id.Logout_item)
        {
            ...
            builder.setPositiveButton("Logout", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    editor.commit();
                    startActivity(new Intent(Display2.this, MainActivity.class));
                    finish();
            ...
            {
                startActivity(new Intent(Display2.this,UserDetailsActivity.class));
            }
