package com.kunal.ecart.options;
...
import com.kunal.ecart.product.ItemDetailsActivity;
import com.kunal.ecart.utility.ImageUrlUtils;

import java.util.ArrayList;

import static com.kunal.ecart.fragments.ImageListFragment.STRING_IMAGE_POSITION;
import static com.kunal.ecart.fragments.ImageListFragment.STRING_IMAGE_URI;
...
//                ((BitmapDrawable) holder.mImageView.getTopLevelDrawable()).getBitmap().recycle();
    ...
    protected void setCartLayout(){
        ...
        if(Display2.notificationCountCart >0){
